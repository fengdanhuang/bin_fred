...
END {
	...
	B_CUDA = HSB * totRatio;
	BErr_Phi = HSB * sqrt(totRatio^2) * totErr;
	printf "	Virial Coefficient = %20.15e %10.3e %5.1e (Intel_Phi)\n\n\n", B_CUDA, BErr_Phi, totErr;
	...
	printf "	Time for ref system = %f seconds = %f minutes = %f hours = %f days. (Intel_Phi)\n", 
				time_Ref, time_Ref/60, time_Ref/3600, time_Ref/3600/24;
	printf "	Time for tar system = %f seconds = %f minutes = %f hours = %f days. (Intel_Phi)\n", 
				time_Tar, time_Tar/60, time_Tar/3600, time_Tar/3600/24;	
	printf "	Total execution time = %f seconds = %f minutes = %f hours = %f days. (Intel_Phi)\n\n", 
				(time_Ref+time_Tar),
	...
	printf "	Speed for ref system = %f step/second. (Intel_Phi)\n", speed_Ref;
	printf "	Speed for tar system = %f step/second. (Intel_Phi)\n", speed_Tarr	
	printf "	General speed = %f step/second = %f thousand_step/second = %f million_step/second. (Intel_Phi)\n\n",
